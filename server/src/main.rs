...
use routes::{
    AppState, LivePeer,
    backups::{
        delete_handler as backups_delete_handler, list_handler as backups_list_handler,
        purge_handler as backups_purge_handler,
    },
...
fn build_router(cfg: &Config, state: AppState) -> Router {
    let protected = Router::new()
        ...
        .route(
            "/api/v1/backups",
            get(backups_list_handler).delete(backups_purge_handler),
        )
